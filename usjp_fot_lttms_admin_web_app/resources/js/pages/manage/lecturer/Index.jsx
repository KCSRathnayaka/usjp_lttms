...
import AddLecturer from '../../../components/my/AddLecturer';
...
export default function Dashboard() {
    ...
    const [isAddLecturerDrawerOpen, setIsAddLecturerDrawerOpen] = useState(false);
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <Card className="shadow-md">
                    <CardHeader className="flex flex-row items-center justify-between">
                        <CardTitle className="text-xl">Lecturer List</CardTitle>
                        <Button onClick={() => setIsAddLecturerDrawerOpen(true)}>
                            Add New Lecturer
                        </Button>
                    </CardHeader>
                    <CardContent>
                        {lecturers.length === 0 ? (
                            <div className="flex flex-col items-center justify-center py-12 text-center text-gray-500">
                                ...
                                <p className="text-lg font-medium mb-2">No lecturers found.</p>
                                <p>Click "Add New Lecturer" to get started!</p>
                            </div>
                        ) : (
                                    ...
                                    <TableBody>
                                        {lecturers.map((lecturer, index) => (
                                            <TableRow key={index}>
                                                ...
                                                <TableCell>{lecturer.mobile_number ?? '-'}</TableCell>
            ...
            {/* Add Lecturer Drawer */}
            <AddLecturer
                isOpen={isAddLecturerDrawerOpen}
                onClose={() => setIsAddLecturerDrawerOpen(false)}
